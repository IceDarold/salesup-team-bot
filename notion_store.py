...
def _contact_from_page(page: dict) -> dict:
    ...
    return {
        ...
        "company": _prop_text(props.get("Компания")),
        "company_site": _prop_url(props.get("Сайт компании")),
        "trigger": _prop_text(props.get("Вакансия / триггер")),
        "additional_context": _prop_text(props.get("Дополнительный контекст")),
